...
import { loadPublishedContent } from './v11-content.js';
...
const store = process.env.DATABASE_URL
  ? new V11PostgresStore({ content: published.content })
  : new V11MemoryStore({ trialClassCode, content: published.content });
